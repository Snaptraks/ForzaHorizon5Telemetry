# Format strings that allows unpack of data bytestream
...
DASH_FORMAT = "<iIfffffffffffffffffffffffffffffffffffffffffffffffffffiiiiifffffffffffffffffHBBBBBBbbb"  # noqa
...
FH5_FORMAT = DASH_FORMAT
FH5_PROPS = SLED_PROPS + DASH_PROPS
